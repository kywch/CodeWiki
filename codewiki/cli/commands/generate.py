...
def generate_command(
    ...
    analysis. Documentation is output to ./wiki/ by default.
    ...
    try:
        ...
        if config is None and use_gemini_cli:
            # Fallback to empty default config if using gemini cli and no config exists
        ...
        generation_options = GenerationOptions(
            ...
            no_cache=no_cache,
            custom_output=output if output != "wiki" else None,
        )
