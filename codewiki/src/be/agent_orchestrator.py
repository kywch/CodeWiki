...
class AgentOrchestrator:
    ...
    def create_agent(
        ...
        relative_root_path = "../"
        if working_dir and self.config.repo_path:
            rel = os.path.relpath(self.config.repo_path, working_dir)
    ...
    async def process_module(
        ...
        # Create agent
        agent = self.create_agent(module_name, components, core_component_ids, working_dir)
